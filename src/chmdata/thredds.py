...
class Thredds:
    ...
    def __init__(
        self, start=None, end=None, date=None, bounds=None, target_profile=None, lat=None, lon=None, clip_feature=None
    ):
        self.start = start
        self.end = end
        self.date = date
...
class TopoWX(Thredds):
    ...
    def get_data_subset(self, grid_conform=False, var="tmax", out_file=None, temp_units_out="C"):
